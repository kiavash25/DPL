...
@section('body')
    <div class="row whiteBase" style="margin-bottom: 100px">
        <div class="col-md-12">
            <h2>
                {{__('Activity Descriptions')}} : {{$activity->name}}
            </h2>
        </div>
        <hr>
...
@section('script')
    ...
    <script>
        ...
        function storeDescription(_id){
            ...
            $.ajax({
                type: 'post',
                url: '{{route("admin.activity.storeTitleText")}}',
                data:{
                    _token: '{{csrf_token()}}',
                    text: value,
                    id: _id
